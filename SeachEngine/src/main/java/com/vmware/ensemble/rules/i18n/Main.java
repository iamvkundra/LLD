...
import com.vmware.ensemble.rules.i18n.engine.impl.InvertedIndexEngine;
...
public class Main {
    public static void main(String[] args) {
        SearchEngine searchEngine = new InvertedIndexEngine();
        ...
        System.out.println(searchEngine.search("demo log"));
        System.out.println(searchEngine.search("not a log line"));
    }
}